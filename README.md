...
| `AUTO_EXCHANGE_PLAN` | ❌ 否 | 设为 `plan500` 时，积分达到 500 自动兑换 100 天；留空则不自动兑换。        |

---

> ⚠️ 当前工作流默认设置了 `AUTO_EXCHANGE_PLAN=plan500`。兑换成功会立即扣除
> 500 积分并增加 100 天会员；如果不希望自动兑换，请删除工作流中的这一环境变量。
